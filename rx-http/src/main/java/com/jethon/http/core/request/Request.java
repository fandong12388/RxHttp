...
import com.jethon.http.core.response.Response;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    private Object mTag;
    private Map<String, String> mAddtionalHeaders;
    ...
    public Request<?> addAddtionalHeader(String key, String value) {
        if (mAddtionalHeaders == null && !TextUtils.isEmpty(key) && !TextUtils.isEmpty(value)) {
            mAddtionalHeaders = new HashMap<String, String>();
        }
        if (!TextUtils.isEmpty(key) && !TextUtils.isEmpty(value)) {
            mAddtionalHeaders.put(key, value);
        }
        return this;
    }
